...
from extras.custom_functions import write_mesh_to_file, calculate_receivers, write_receivers_to_file, draw_mesh
...
if __name__ == "__main__":
    ...
    for i in range(dataset_size):
        ...
        receivers = generate_receivers(start_pnt.x, end_pnt.x, 100)
        ...
        # draw_mesh(fig, _mesh)
        # plt.savefig(f"datasets/plots/mesh_{i}.png")
        # plt.close(fig)